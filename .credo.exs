    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Consistency.SpaceAroundOperators, priority: :normal},
          ...
          {Credo.Check.Refactor.IoPuts, priority: :normal},
          ...
          {Credo.Check.Warning.IExPry, priority: :normal},
          {Credo.Check.Warning.IoInspect, priority: :normal},
